        ...
        <>
            <FooterContainer>
                <div className="breaker">
                    <FooterHeadline>lorem</FooterHeadline>
                    <FooterLinks>
                        <FooterLink href="#">hola</FooterLink>
                ...
                <div className="breaker">
                    ...
                    <FooterLinks>
                        <FooterLink href="#">Apply for kisan mantri card</FooterLink>
                        <FooterLink href="#">Public Grievance</FooterLink>
                        <FooterLink href="#">RTI Online</FooterLink>
                        <FooterLink href="#">Kisan Union registration system</FooterLink>
