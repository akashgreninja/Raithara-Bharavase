...
const OTPVerificationx = () => {
    ...
    const handleContinue = () => {
        if (otp === "1234") {
            navigate("/userx/dashboard/6q7r8s9t-0u1v-2w3x-4y5z-a6b7c8d9e0f")
        }
        else if (otp === "2345") {
            navigate("/userx/dashboard/6q7r8s9t-0u1v-2w3x-4y5z-a6b7c8d9e2e")

        }
        else {
            navigate("/userx/dashboard/1a2b3c4d-5e6f-7g8h-9i0j-k1l2m3n4o5p")
        }
    }
...
export default OTPVerificationx;
