  ...
  return (
    <NavbarContainer>
      ...
      <NavLinks>
        ...
        <NavItem>
          <NewFlag>New</NewFlag>
          <Button color="primary" onClick={() => navigate("/register")}> Vote for your candidate</Button>
        </NavItem>
        <NavItem>
          <NewFlag>New</NewFlag>
          <Button color="primary" onClick={() => navigate("/login")}> Customer Care</Button>
        </NavItem>

        <NavItem style={{ marginLeft: '20px' }}>
          {/* <Button color="primary" variant='contained'> Login/Register </Button> */}
          <LoginButton onClick={() => navigate("/loginforinf")}>Login/Register for schemes</LoginButton>
        </NavItem>
      </NavLinks>
    </NavbarContainer>
  )
