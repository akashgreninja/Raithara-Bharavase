...
var baseLayer = L.tileLayer(
  ...
  {
    attribution:
      '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> | GIS Simplified',
  }
);
...
info.update = function (props) {
  this._div.innerHTML =
    "<h2>Raitha Bharvase Tracker </h2>" + "<br />FOR THE FARMERS ALWAYS";
};
...
legend.onAdd = function (map) {
  ...
  div.innerHTML +=
    '<i class="icon" style="background-image: url(https://d30y9cdsu7xlg0.cloudfront.net/png/194515-200.png);background-repeat: no-repeat;"></i><span>LEGEND</span><br>';
  return div;
};
...
var zooms2 = [[5], [4]];
var fileTime = ["Govt of India", "Famer's Portal"];
for (var i = 0; i < fileTime.length; i++) {
  (function () {
    var time = String(fileTime[i]);
    let zo = zooms2[i];
      ...
      states: [
        {
          icon: "<strong>" + time + "</strong>",
          onClick: function (e) {
            if (time == "Govt of India") {
              let co = map.getCenter();
              let URL = "https://agricoop.nic.in/#gsc.tab=0";
              window.open(URL, "_blank");
            } else {
              let co = map.getCenter();
              let URL = "https://farmer.gov.in/";
              window.open(URL, "_blank");
            }
  ...
  let popupContent = `
      <form class="popup-form">  
        <div class="form-group">
          ...
          <textarea class="form-control" rows="4" class="comment" id="check"></textarea>${hmm}
        </div>
        <div class="d-flex">  
    ...
    $(".delete-button").on("click", (e) => {
      ...
      markert.bindPopup(
        '<div class="content-pop">' +
          ...
          "</center>" +
          '<br><br> <button class="button-7" role="button" ' +
          "onclick=" +
          '"' +
          "window.open(" +
          "'" +
...
for (var i = 0; i < stads.length; i++) {
  ...
  marker.bindPopup(
    '<div class="content-pop">' +
      ...
      "Anna Merchants " +
      "<br> <br> <center>" +
      '<button class="button-7" role="button">See Schedule</button>' +
      "</center>" +
      "<br>" +
      '<button class="button-7" role="button" ' +
      "onclick=" +
...
for (var i = 0; i < shops.length; i++) {
  ...
  var title = a.Name;
  if (a.Type == "rcheck") {
    var marker = L.marker(new L.LatLng(a.Latitude, a.Longtitude), {
      icon: greenIcon,
      title: title,
    });
  } else {
  ...
  marker.bindPopup(
    '<div class="content-pop">' +
      ...
      a.ID +
      "<br> <br> <center>" +
      '<button class="button-7" role="button">See Prices</button>' +
      "</center>" +
      "<br>" +
      '<button class="button-7" role="button" ' +
      "onclick=" +
...
L.control.layers(null, overlayLayers).addTo(map);
>>>>>>> 399530ad330f2c2d18eba95e99e7b5294d525642
